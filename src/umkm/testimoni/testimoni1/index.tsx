...
interface ITestimoni {
   ...
   jobs: string;
   description: string;
   imageTestimoni: string;
}

function TestimonialCard({ index, title, jobs, description, imageTestimoni }: ITestimoni) {
   return (
      <Flex
         boxShadow={'lg'}
         maxW={'640px'}
...
export default function Testimoni1() {
   return (
      <Flex
         textAlign={'center'}
         pt={10}
         ...
         px={5}
      >
         <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'} maxW="100%">
            <chakra.h3
