import { Badge, Box, Icon, Collapse, Flex, Text, useDisclosure, Divider } from '@chakra-ui/react';
import { Link } from 'react-router-dom';
import { FaAngleDown, FaAngleUp } from 'react-icons/fa';
import { DashboardSidebarItemProps } from 'ts/DashboardSidebar';

const DashboardSidebarItemUser = ({ item, pathname }: DashboardSidebarItemProps) => {
